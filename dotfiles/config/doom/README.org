...
| ~/.config/orgTemplates/Pentest.org              | New Pentest   | n            |
| ~/.config/orgTemplates/ToolTemplate.org         | Tool          | t            |
| ~/.config/orgTemplates/MethodTemplate.org       | Method        | m            |
...
| ~/.config/orgTemplates/ProjectStartTemplate.org | Start Project | p            |
| ~/.config/orgTemplates/ProjectEndTemplate.org   | End Project   | P            |
